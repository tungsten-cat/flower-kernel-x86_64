...
build-x86_64: $(x86_64_asm_object_files)
	...
	x86_64-elf-ld -n -o release/x86_64/kernel.bin -T targets/x86_64/linker.ld $(x86_64_asm_object_files) && \
	cp release/x86_64/kernel.bin targets/x86_64/iso/boot/kernel.bin && \
	grub-mkrescue /usr/lib/grub/i386-pc -o release/x86_64/kernel.iso targets/x86_64/iso